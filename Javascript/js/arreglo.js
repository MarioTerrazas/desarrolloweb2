...
carrito.slice().sort((a, b) => a.precio - b.precio);
console.log(carrito);

console.log("IMPRESIÓN ORDENADA POR NOMBRE");
carrito.sort((a, b) => a.nombre - b.nombre);
console.slice().log(carrito);
console.long("IMPRESOIN ORDEADO POR PRECIO")
console.sort((a,b)=>a.precio - b.precio)
console.long(carrito)*/
console.log("IMPRESIÓN ORDENADA POR PRECIO");
